...
export class Backend implements backendInterface {
    ...
    async countDeletedEntities(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countDeletedEntities();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countEntities(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countEntities();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createEntity(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createEntity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteEntity(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async extractTextFromImage(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.extractTextFromImage(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchCitationFromUrl(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchCitationFromUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateColdEmail(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateColdEmail(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateFlashcards(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateFlashcards(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateScholarshipEssay(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateScholarshipEssay(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntity(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateEntity(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEntity(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
